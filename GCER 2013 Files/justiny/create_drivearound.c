...
{
	create_connect();
	create_drive_direct(D_SPEED,D_SPEED);
	create_wait_event(LEFT_BUMP);
	create_backward(80,D_SPEED);
	create_block();
	msleep(10);
	create_drive_direct_right(70,DSPEED,90);
	create_drive_direct(D_SPEED,D_SPEED);
	create_wait_event(LEFT_BUMP);
	create_backward(80,D_SPEED);
	create_block();
	msleep(10);
	create_drive_direct_right(70,D_SPEED,90);
	create_disconnect();
}
